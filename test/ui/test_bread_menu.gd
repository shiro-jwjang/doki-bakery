...
func test_bread_menu_filters_by_level():
	...
	assert_gt(level_3_breads.size(), level_1_breads.size(),
...
func test_bread_menu_emits_bread_selected_signal():
	...
	assert_signal_emitted(BreadMenu, "bread_selected",
		"Should emit bread_selected signal when bread is selected")
...
func test_bread_menu_connects_to_production_manager():
	...
	assert_true(ProductionManager.active_baking.has(0),
